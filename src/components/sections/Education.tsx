            ...
            >
              <TiltCard intensity={5}>
                <div className="glass flex flex-col gap-5 rounded-2xl p-7 shadow-card sm:flex-row sm:items-center">
                  <span className="grid h-16 w-16 shrink-0 place-items-center rounded-2xl bg-gradient-to-br from-accent/30 to-accent-glow/20 text-3xl text-strong">
                    <HiAcademicCap />
                  </span>
                  <div className="flex-1">
                    ...
                    <p className="mt-2 text-base">{edu.institution}</p>
                  </div>
                  <div className="rounded-xl border border-line/10 bg-card/[0.04] px-5 py-3 text-center">
